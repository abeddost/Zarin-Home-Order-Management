...
export default async function AdminNewOrderPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <Link href="/admin420/orders" className="inline-flex items-center gap-1 text-sm text-stone-500 hover:text-stone-800 mb-4">
      ...
      <OrderForm customers={customers} products={products} basePath="/admin420/orders" />
    </div>
  )
}
